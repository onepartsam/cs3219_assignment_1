...
public class Main {
	...
	public static enum ArchiDesignType {
		...
		START_OF_LIST(ARCHI_TYPE_START_INDEX), //DO NOT REMOVE, ADD NEW STRUCTURES BELOW
		ADT(101),
		DATAFLOW(102),
		END_OF_LIST(103);	//DO NOT REMOVE, ADD NEW STRUCTURES ABOVE
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			//***TO SAM - Sorry i change your code for the program's expandability***//
			...
			if (userOption <= ArchiDesignType.START_OF_LIST.getValue() 
				...
				//Calls relative method to user's input choice //DUMMY FUNCTION BELOW - REMOVE WHEN SUBMISSION
